...
/**
 * Created by pc on 2019/4/26.
 */

public class ItemLvAboutAppAdapter extends BaseAdapter {
    ...
    public ItemLvAboutAppAdapter(Context context) {
        this.context = context;
        this.layoutInflater = LayoutInflater.from(context);
        mEntities =  context.getResources().getStringArray(R.array.about_app_items);
    }
